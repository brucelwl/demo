...
//    private static final Logger logger = LoggerFactory.getLogger(MethodBenchmark2.class);
//
//    Bean1 bean1;
//    Method say;
//
//    public MethodBenchmark2() {
...
//        Method say = Bean1.class.getMethod("say");
//        Object value = say.invoke(bean1);
//        blackhole.consume(value);
//        //logger.info("test3");
//    }
...
//        Options options = new OptionsBuilder().include(MethodBenchmark2.class.getSimpleName())
