...
public class MethodBenchmark {
    private static final Logger logger = LoggerFactory.getLogger(MethodBenchmark.class);
    ...
    public void setup() throws Exception {
        bean1 = new Bean1();
        say = Bean1.class.getMethod("addObj", Integer.class, Integer.class);
        logger.info("setup..........");
    }
    ...
    @Benchmark
    public void testObj3(Blackhole blackhole) throws Exception {
        Method say = Bean1.class.getMethod("addObj", Integer.class, Integer.class);
        Object value = say.invoke(bean1, 1, 256);
        blackhole.consume(value);
        //logger.info("test3");
    }
    ...
    public static void main(String[] args) throws RunnerException, IOException {
        Options options = new OptionsBuilder().include(MethodBenchmark.class.getName())
