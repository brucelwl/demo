...
public class BenchmarkTest2 {
    private static final Logger logger = LoggerFactory.getLogger(BenchmarkTest2.class);

    @Benchmark
    public void testObj1(Blackhole blackhole) throws Exception {
        Bean beanImpl = new BeanImpl();
        beanImpl.addSampleProperty("testObj1");
        String sampleProperty = beanImpl.getSampleProperty();
    ...
    public static void main(String[] args) throws RunnerException, IOException {
        Options options = new OptionsBuilder().include(BenchmarkTest2.class.getName())
