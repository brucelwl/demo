...
/**
 * Internal strategy used by {@link MyBinder} to bind aggregates (Maps, Lists, Arrays).
 *
...
abstract class AggregateBinder<T> {
	...
	private final MyBinder.Context context;

	AggregateBinder(MyBinder.Context context) {
	 ...
	 * @return the context
	 */
	protected final MyBinder.Context getContext() {
		return this.context;
	}
