 ...
 * {@link MyBinder binding}.
 *
 * @author Phillip Webb
 * @author Madhura Bhave
 * @since 2.0.0
 */
public interface MyBindHandler {

    /**
     * Default no-op bind handler.
     */
    MyBindHandler DEFAULT = new MyBindHandler() {
     ...
     * update by bruce
     */
    default Object onFinish(ConfigurationPropertyName name, Bindable<?> target,
     ...
     * add by bruce
     */
    default boolean onNoDescendSkip(ConfigurationPropertyName name, Bindable<?> target, BindContext context) {
        return true;
    }
}
